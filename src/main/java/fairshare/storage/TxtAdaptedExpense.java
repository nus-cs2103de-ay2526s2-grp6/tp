...
/**
 * A plain-text-friendly representation of an {@code Expense}.
 * Each expense is serialized as a single pipe-delimited line in the
 * format:
 * {@code expenseName|amount|payerName|participant1:shares,...|tag1,...}
 */
public class TxtAdaptedExpense {
    ...
    /**
     * Constructs a {@code TxtAdaptedExpense} from an {@code Expense}
     * model object.
     *
    ...
    /**
     * Constructs a {@code TxtAdaptedExpense} with all fields specified
     ...
     * @param participants the list of adapted participants;
     *                     cannot be null.
     * @param tags         the list of adapted tags; cannot be null.
     */
    public TxtAdaptedExpense(String expenseName, double amount,
                             TxtAdaptedPerson payer,
                             List<TxtAdaptedParticipant> participants,
    ...
    /**
     * Returns the list of participants of this expense.
     *
     * @return a list of {@code TxtAdaptedParticipant}.
     */
    ...
    /**
     * Converts this adapted expense back into an {@code Expense}
     * model object.
     *
    ...
    public Expense toModelType() {
        ...
        return new Expense(expenseName, amount,
                payer.toModelType(), participantList, tagList);
    }

    /**
     * Serializes this expense into a single pipe-delimited plain-text
     * line.
     *
    ...
    /**
     * Deserialises a pipe-delimited plain-text line into a
     * {@code TxtAdaptedExpense}.
     * Expected format:
     * {@code expenseName|amount|payer|p1:s1,p2:s2|tag1,tag2}
     *
    ...
    public static TxtAdaptedExpense deserialize(String line) {
        ...
        List<TxtAdaptedParticipant> participants =
                Arrays.stream(parts[3].split(LIST_SEPARATOR))
                        .filter(s -> !s.isBlank())
                        .map(TxtAdaptedParticipant::deserialise)
                        .collect(Collectors.toList());
        ...
        return new TxtAdaptedExpense(expenseName, amount,
